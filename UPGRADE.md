...
+ [#1075](https://github.com/luyadev/luya/issues/1075) rontend and Admin Controller and Module assets can not be stored in the `$assets` property of a module or controller any more.
