...
+ [#1977](https://github.com/luyadev/luya/pull/1978) Updated SubmitButtonWidget from `click` to `beforeSubmit` event. Supporting multi form (including pjax) on same page.
