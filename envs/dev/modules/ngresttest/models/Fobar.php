...
class Fobar extends NgRestModel
{
    ...
    {
        return [
            ['list', ['image', 'imageArray', 'file', 'fileArray', 'text', 'textarea', 'selectArray', 'checkboxList', 'checkboxRelation', 'color', 'date', 'datetime', 'decimal', 'number', 'password', 'selectClass', 'toggleStatus', 'sortRelationArray', 'sortRelationModel', 'i18n_image', 'i18n_imageArray', 'i18n_file', 'i18n_fileArray', 'i18n_text', 'i18n_textarea', 'i18n_selectArray', 'i18n_checkboxList', 'i18n_checkboxRelation', 'i18n_color', 'i18n_date', 'i18n_datetime', 'i18n_decimal', 'i18n_number', 'i18n_password', 'i18n_selectClass', 'i18n_toggleStatus', 'i18n_sortRelationArray', 'i18n_sortRelationModel']],
            [['create', 'update'], ['image', 'imageArray', 'file', 'fileArray', 'text', 'textarea', 'selectArray', 'checkboxList', 'checkboxRelation', 'color', 'date', 'datetime', 'decimal', 'number', 'password', 'selectClass', 'toggleStatus', 'sortRelationArray', 'sortRelationModel', 'i18n_image', 'i18n_imageArray', 'i18n_file', 'i18n_fileArray', 'i18n_text', 'i18n_textarea', 'i18n_selectArray', 'i18n_checkboxList', 'i18n_checkboxRelation', 'i18n_color', 'i18n_date', 'i18n_datetime', 'i18n_decimal', 'i18n_number', 'i18n_password', 'i18n_selectClass', 'i18n_toggleStatus', 'i18n_sortRelationArray', 'i18n_sortRelationModel']],
            ['delete', false],
        ];
    }
}