...
class m151214_095728_add_more_user_data extends Migration
{
    public function safeUp()
    {
        ...
        $this->addColumn('account_user', 'city', $this->string(80));
        $this->addColumn('account_user', 'country',$this->string(80));
        $this->addColumn('account_user', 'company', $this->string(80));
        $this->addColumn('account_user', 'subscription_newsletter', $this->boolean()->defaultValue(0));
        $this->addColumn('account_user', 'subscription_medianews', $this->boolean()->defaultValue(0));
        $this->addColumn('account_user', 'verification_hash', $this->string(80));
        $this->addColumn('account_user', 'is_mail_verified', $this->boolean()->defaultValue(0));
        $this->addColumn('account_user', 'is_active', $this->boolean()->defaultValue(0));
    }
