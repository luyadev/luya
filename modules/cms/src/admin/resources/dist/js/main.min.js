...
zaa.directive("menuDropdown",function(ServiceMenuData){return{restrict:"E",scope:{navId:"="},controller:function($scope){$scope.changeModel=function(data){$scope.navId=data.id};$scope.menuData=ServiceMenuData.data;$scope.$on("service:MenuData",function(event,data){$scope.menuData=data});function init(){if($scope.menuData.length==0){ServiceMenuData.load()}}for(var container in $scope.menuData.containers){$scope.menuData.containers[container].isHidden=false}$scope.toggler=true;init()},template:function(){return"<div class=\"menu-dropdown-category\">"+"<b class=\"menu-dropdown-toggle-all\" ng-click=\"toggler=!toggler\"><i class=\"material-icons\" ng-if=\"!toggler\">keyboard_arrow_right</i><i class=\"material-icons\" ng-if=\"toggler\">keyboard_arrow_down</i><span>Toggle Containers</span></b><br />"+"<div class=\"menu-dropdown-container\" ng-show=\"toggler\">"+"<ul class=\"treeview treeview-chooser\">"+"<li class=\"treeview-container\" ng-repeat=\"container in menuData.containers\" ng-show=\"(menuData.items | menuparentfilter:container.id:0).length > 0\">"+"<div class=\"treeview-label treeview-label-container\" ng-click=\"container.isHidden=!container.isHidden\">"+"<span class=\"treeview-icon treeview-icon-collapse\">"+"<i class=\"material-icons\" ng-show=\"!container.isHidden\">keyboard_arrow_right</i>"+"<i class=\"material-icons\" ng-show=\"container.isHidden\">keyboard_arrow_down</i>"+"</span>"+"<span class=\"treeview-link\">"+"<span class=\"google-chrome-font-offset-fix\">{{container.name}}</span>"+"</span>"+"</div>"+"<ul class=\"treeview-items treeview-items-lvl1\" ng-hide=\"!container.isHidden\">"+"<li class=\"treeview-item treeview-item-lvl1\" ng-class=\"{'treeview-item-has-children' : (menuData.items | menuparentfilter:container.id:0).length}\" ng-repeat=\"data in menuData.items | menuparentfilter:container.id:0\" ng-include=\"'menuDropdownReverse'\"></li>"+"</ul>"+"</li>"+"</ul>"+"</div>"+"<div>"}}});zaa.directive("zaaCmsPage",function($compile){return{restrict:"E",scope:{"model":"=","options":"=","label":"@label","i18n":"@i18n","id":"@fieldid","name":"@fieldname"},template:function(){return"<div class=\"form-group form-side-by-side\" ng-class=\"{'input--hide-label': i18n}\">"+"<div class=\"form-side form-side-label\">"+"<label>{{label}}</label>"+"</div>"+"<div class=\"form-side\">"+"<menu-dropdown class=\"menu-dropdown\" nav-id=\"model\" />"+"</div>"+"</div>"}}});zaa.directive("showInternalRedirection",function(){return{restrict:"E",scope:{navId:"="},controller:function($scope,$http,$state){$scope.$watch("navId",function(n){if(n){$http.get("admin/api-cms-navitem/get-nav-item-path",{params:{navId:$scope.navId}}).then(function(response){$scope.path=response.data});$http.get("admin/api-cms-navitem/get-nav-container-name",{params:{navId:$scope.navId}}).then(function(response){$scope.container=response.data})}});$scope.goTo=function(navId){$state.go("custom.cmsedit",{navId:navId})}},template:function(){return"<a ng-click=\"goTo(navId)\" style=\"cursor:pointer\">{{path}}</a> in {{container}}"}}});zaa.directive("updateFormPage",function(){return{restrict:"EA",scope:{data:"="},templateUrl:"updateformpage.html",controller:function($scope){$scope.parent=$scope.$parent.$parent;$scope.isEditAvailable=function(){return $scope.parent.item.nav_item_type==1}}}});zaa.directive("updateFormModule",function(){return{restrict:"EA",scope:{data:"="},templateUrl:"updateformmodule.html",controller:function($scope,$http){$scope.modules=[];$http.get("admin/api-admin-common/data-modules").then(function(response){$scope.modules=response.data})}}});zaa.directive("updateFormRedirect",function(){return{restrict:"EA",scope:{data:"="},templateUrl:"updateformredirect.html",controller:function($scope){$scope.$watch(function(){return $scope.data},function(n,o){if(angular.isArray(n)){$scope.data={}}})}}});zaa.directive("createForm",function(){return{restrict:"EA",scope:{data:"="},templateUrl:"createform.html",controller:function($scope,$http,$filter,ServiceMenuData,ServiceLanguagesData,AdminToastService){$scope.error=[];$scope.success=false;$scope.controller=$scope.$parent;$scope.menuData=ServiceMenuData.data;$scope.$on("service:MenuData",function(event,data){$scope.menuData=data});$scope.menuDataReload=function(){return ServiceMenuData.load(true)};function initializer(){$scope.menu=$scope.menuData.items;$scope.navcontainers=$scope.menuData.containers}initializer();$scope.data.nav_item_type=1;$scope.data.parent_nav_id=0;$scope.data.is_draft=0;$scope.data.nav_container_id=1;$scope.languagesData=ServiceLanguagesData.data;$scope.$on("service:LanguagesData",function(event,data){$scope.languagesData=data});$scope.data.lang_id=parseInt($filter("filter")($scope.languagesData,{"is_default":"1"},true)[0].id);$scope.navitems=[];$scope.$watch(function(){return $scope.data.nav_container_id},function(n,o){if(n!==undefined&&n!==o){$scope.data.parent_nav_id=0;$scope.navitems=$scope.menu[n]["__items"]}});$scope.aliasSuggestion=function(){$scope.data.alias=$filter("slugify")($scope.data.title)};$scope.$watch("data.alias",function(n,o){if(n!=o&&n!=null){$scope.data.alias=$filter("slugify")(n)}});$scope.exec=function(){$scope.controller.save().then(function(response){$scope.menuDataReload();$scope.success=true;$scope.error=[];$scope.data.title=null;$scope.data.alias=null;if($scope.data.isInline){$scope.$parent.$parent.getItem($scope.data.lang_id,$scope.data.nav_id)}AdminToastService.success(i18n["view_index_page_success"],4000)},function(reason){angular.forEach(reason,function(value,key){AdminToastService.error(value[0],2000)});$scope.error=reason})}}}});zaa.directive("createFormPage",function(ServiceLayoutsData,ServiceMenuData){return{restrict:"EA",scope:{data:"="},templateUrl:"createformpage.html",controller:function($scope){$scope.data.use_draft=0;$scope.data.layout_id=0;$scope.data.from_draft_id=0;/* layoutsData */$scope.layoutsData=ServiceLayoutsData.data;$scope.$on("service:BlocksData",function(event,data){$scope.layoutsData=data});/* menuData */$scope.menuData=ServiceMenuData.data;$scope.$on("service:MenuData",function(event,data){$scope.menuData=data});function init(){$scope.drafts=$scope.menuData.drafts;$scope.layouts=$scope.layoutsData}init();$scope.save=function(){$scope.$parent.exec()}}}});zaa.directive("createFormModule",function($http){return{restrict:"EA",scope:{data:"="},templateUrl:"createformmodule.html",controller:function($scope){$scope.modules=[];$http.get("admin/api-admin-common/data-modules").then(function(response){$scope.modules=response.data});$scope.save=function(){$scope.$parent.exec()}}}});zaa.directive("createFormRedirect",function(){return{restrict:"EA",scope:{data:"="},templateUrl:"createformredirect.html",controller:function($scope){$scope.save=function(){$scope.$parent.exec()}}}});/* factory.js */zaa.factory("PlaceholderService",function(){var service=[];service.status=1;/* 1 = showplaceholders; 0 = hide placeholders */service.delegate=function(status){service.status=status};return service});/* layout.js */zaa.config(function($stateProvider,resolverProvider){$stateProvider.state("custom.cmsedit",{url:"/update/:navId",templateUrl:"cmsadmin/page/update"}).state("custom.cmsadd",{url:"/create",templateUrl:"cmsadmin/page/create"}).state("custom.cmsdraft",{url:"/drafts",templateUrl:"cmsadmin/page/drafts"})});zaa.controller("DraftsController",function($scope,$state,ServiceMenuData){$scope.menuData=ServiceMenuData.data;$scope.$on("service:MenuData",function(event,data){$scope.menuData=data});$scope.go=function(navId){$state.go("custom.cmsedit",{navId:navId})}});/* controllers */zaa.controller("CmsDashboard",function($scope,$http){$scope.dashboard=[];$http.get("admin/api-cms-admin/dashboard-log").then(function(response){$scope.dashboard=response.data})});zaa.controller("ConfigController",function($scope,$http,AdminToastService){$scope.data={};$http.get("admin/api-cms-admin/config").then(function(response){$scope.data=response.data});$scope.save=function(){$http.post("admin/api-cms-admin/config",$scope.data).then(function(response){AdminToastService.success(i18n["js_config_update_success"],4000)})}});zaa.controller("PageVersionsController",function($scope,$http,ServiceLayoutsData,AdminToastService){/**
		 ...
		 * @var integer $versionLayoutId From ng-model, only if fromVersionPageId is 0
 		 */var headers={"headers":{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}};/* layoutsData */$scope.layoutsData=ServiceLayoutsData.data;$scope.$on("service:LayoutsData",function(event,data){$scope.layoutsData=data});/* controller logic */$scope.createNewVersionSubmit=function(data){if(data==undefined){AdminToastService.error(i18n["js_version_error_empty_fields"],4000);return null}if(data.copyExistingVersion){data.versionLayoutId=0}$http.post("admin/api-cms-navitem/create-page-version",$.param({"layoutId":data.versionLayoutId,"navItemId":$scope.item.id,"name":data.versionName,"fromPageId":data.fromVersionPageId}),headers).then(function(response){if(response.data.error){AdminToastService.error(i18n["js_version_error_empty_fields"],4000);return null}$scope.refreshForce();AdminToastService.success(i18n["js_version_create_success"],4000)})}});zaa.controller("CopyPageController",function($scope,$http,$filter,AdminToastService){var headers={"headers":{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}};$scope.$on("deletedNavItem",function(){$scope.isOpen=false;$scope.itemSelection=false;$scope.selection=0});$scope.NavItemController=$scope.$parent;$scope.navId=0;$scope.items=null;$scope.isOpen=false;$scope.itemSelection=false;$scope.selection=0;$scope.select=function(item){$scope.selection=item.id;$scope.itemSelection=angular.copy(item)};$scope.$watch("itemSelection.title",function(n,o){if(n){$scope.aliasSuggestion()}});$scope.aliasSuggestion=function(){$scope.itemSelection.alias=$filter("slugify")($scope.itemSelection.title)};$scope.loadItems=function(){$scope.navId=$scope.NavItemController.NavController.navData.id;$http.get("admin/api-cms-nav/find-nav-items",{params:{navId:$scope.navId}}).then(function(response){$scope.items=response.data;$scope.isOpen=true})};$scope.save=function(){$scope.itemSelection["toLangId"]=$scope.NavItemController.lang.id;$http.post("admin/api-cms-nav/create-from-page",$.param($scope.itemSelection),headers).then(function(response){if(response.data){AdminToastService.success(i18n["js_added_translation_ok"],3000);$scope.NavItemController.refresh()}else{AdminToastService.error(i18n["js_added_translation_error"],5000)}})}});zaa.filter("menuparentfilter",function(){return function(input,containerId,parentNavId){var result=[];angular.forEach(input,function(value,key){if(value.parent_nav_id==parentNavId&&value.nav_container_id==containerId){result.push(value)}});return result}});zaa.filter("menuchildfilter",function(){return function(input,containerId,parentNavId){var returnValue=false;angular.forEach(input,function(value,key){if(!returnValue){if(value.id==parentNavId&&value.nav_container_id==containerId){returnValue=value}}});return returnValue}});zaa.controller("CmsMenuTreeController",function($scope,$state,$http,$filter,ServiceMenuData,ServiceLiveEditMode){// live edit service
...
$scope.layoutsData=ServiceLayoutsData.data;$scope.$on("service:BlocksData",function(event,data){$scope.layoutsData=data});// serviceMenuData inheritance
...
$scope.isTranslated=false;$scope.item=[];$scope.itemCopy=[];$scope.settings=false;$scope.typeDataCopy=[];$scope.typeData=[];$scope.container=[];$scope.errors=[];$scope.homeUrl=$rootScope.luyacfg.homeUrl;$scope.currentPageVersion=0;$scope.currentPageVersionAlias;$scope.trashItem=function(){if($scope.lang.is_default==0){AdminToastService.confirm(i18n["js_page_confirm_delete"],i18n["cmsadmin_settings_trashpage_title"],function($timeout,$toast){$http.delete("admin/api-cms-navitem/delete?navItemId="+$scope.item.id).then(function(response){$scope.menuDataReload().then(function(){$scope.isTranslated=false;$scope.item=[];$scope.itemCopy=[];$scope.settings=false;$scope.typeDataCopy=[];$scope.typeData=[];$scope.container=[];$scope.errors=[];$scope.currentPageVersion=0;$scope.$broadcast("deletedNavItem");$toast.close()})},function(response){AdminToastService.error(i18n["js_page_delete_error_cause_redirects"],5000)})})}};$scope.reset=function(){$scope.itemCopy=angular.copy($scope.item);if($scope.item.nav_item_type==1){$scope.typeDataCopy=angular.copy({"nav_item_type_id":$scope.item.nav_item_type_id})}else{$scope.typeDataCopy=angular.copy($scope.typeData)}};$scope.updateNavItemData=function(itemCopy,typeDataCopy){$scope.errors=[];var headers={"headers":{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}};var navItemId=itemCopy.id;typeDataCopy.title=itemCopy.title;typeDataCopy.alias=itemCopy.alias;typeDataCopy.title_tag=itemCopy.title_tag;typeDataCopy.description=itemCopy.description;typeDataCopy.keywords=itemCopy.keywords;$http.post("admin/api-cms-navitem/update-page-item?navItemId="+navItemId+"&navItemType="+itemCopy.nav_item_type,$.param(typeDataCopy),headers).then(function successCallback(response){if(itemCopy.nav_item_type!==1){$scope.currentPageVersion=0}$scope.loaded=false;AdminToastService.success(i18nParam("js_page_item_update_ok",{"title":itemCopy.title}),2000);$scope.menuDataReload();$scope.refresh();$scope.toggleSettingsOverlay();$scope.reset()},function errorCallback(response){$scope.errors=response.data})};$scope.$watch("itemCopy.alias",function(n,o){if(n!=o&&n!=null){$scope.itemCopy.alias=$filter("slugify")(n)}});$scope.removeVersion=function(version){AdminToastService.confirm(i18nParam("js_version_delete_confirm",{alias:version.version_alias}),i18n["cmsadmin_version_remove"],function($toast,$http){$http.post("admin/api-cms-navitem/remove-page-version",{pageId:version.id}).then(function(response){$scope.refreshForce();$toast.close();AdminToastService.success(i18nParam("js_version_delete_confirm_success",{alias:version.version_alias}),5000)})})};$scope.editVersionItem;$scope.tab=1;$scope.editVersion=function(versionItem){$scope.changeTab(4);$scope.editVersionItem=versionItem};$scope.editVersionUpdate=function(editVersionItem){$http.post("admin/api-cms-navitem/change-page-version-layout",{"pageItemId":editVersionItem.id,"layoutId":editVersionItem.layout_id,"alias":editVersionItem.version_alias}).then(function(response){$scope.refreshForce();AdminToastService.success(i18n["js_version_update_success"],4000);$scope.toggleSettingsOverlay()})};$scope.getItem=function(langId,navId){$http({url:"admin/api-cms-navitem/nav-lang-item",method:"GET",params:{langId:langId,navId:navId}}).then(function(response){if(response.data){if(!response.data.error){$scope.item=response.data["item"];$scope.typeData=response.data["typeData"];$scope.isTranslated=true;$scope.reset();if(!response.data["nav"].is_draft){$scope.NavController.bubbleParents($scope.NavController.navData.parent_nav_id,$scope.NavController.navData.nav_container_id);if($scope.item.nav_item_type==1){if($scope.currentPageVersion==0){$scope.currentPageVersion=response.data.item.nav_item_type_id}if(response.data.item.nav_item_type_id in response.data.typeData){$scope.currentPageVersionAlias=$scope.container=response.data.typeData[$scope.currentPageVersion]["version_alias"];$scope.container=response.data.typeData[$scope.currentPageVersion]["contentAsArray"]}}}else{$scope.currentPageVersion=response.data.item.nav_item_type_id;$scope.container=response.data.typeData[$scope.currentPageVersion]["contentAsArray"]}}$scope.loaded=true}})};$scope.versionDropDownVisbility=false;$scope.toggleVersionsDropdown=function(){$scope.versionDropDownVisbility=!$scope.versionDropDownVisbility};$scope.switchVersion=function(pageVersionid){$scope.container=$scope.typeData[pageVersionid]["contentAsArray"];$scope.currentPageVersionAlias=$scope.typeData[pageVersionid]["version_alias"];$scope.currentPageVersion=pageVersionid;$scope.loadLiveUrl();$scope.toggleVersionsDropdown()};$scope.refreshForce=function(){$scope.getItem($scope.lang.id,$scope.NavController.id)};$scope.refresh=function(){if(AdminLangService.isInSelection($scope.lang.short_code)){$scope.getItem($scope.lang.id,$scope.NavController.id)}};/* new settings overlay */$scope.settingsOverlayVisibility=true;$scope.toggleSettingsOverlay=function(tab){$scope.settingsOverlayVisibility=!$scope.settingsOverlayVisibility;if(tab){$scope.tab=tab}};$scope.changeTab=function(tab){$scope.tab=tab};/**
		 ...
		 */$scope.dropItemPlaceholder=function(dragged,dropped,position){if(dragged.hasOwnProperty("favorized")||dragged.hasOwnProperty("newblock")){// its a new block
$http.post("admin/api-cms-navitempageblockitem/create",{prev_id:dropped.prev_id,sort_index:0,block_id:dragged.id,placeholder_var:dropped["var"],nav_item_page_id:dropped.nav_item_page_id}).then(function(response){$scope.refreshNested(dropped["prev_id"],dropped["var"])})}else if(dragged.hasOwnProperty("copystack")){// its a block from copy stack
$http.post("admin/api-cms-navitemblock/copy-block-from-stack",{copyBlockId:dragged.id,sort_index:0,prev_id:dropped.prev_id,placeholder_var:dropped["var"],nav_item_page_id:dropped.nav_item_page_id}).then(function(response){$scope.refreshNested(dropped["prev_id"],dropped["var"])})}else{// moving an existing block
$http.put("admin/api-cms-navitempageblockitem/update?id="+dragged.id,{sort_index:0,prev_id:dropped.prev_id,placeholder_var:dropped["var"]}).then(function(response){$scope.refreshForce()})}};$scope.refresh()});/**
	 * @param $scope.block From ng-repeat scope assignment
	 */zaa.controller("PageBlockEditController",function($scope,$sce,$http,AdminClassService,AdminToastService,ServiceBlockCopyStack,ServiceLiveEditMode){$scope.NavItemTypePageController=$scope.$parent;/**
		 * drops an item in an empty placeholder of a BLOCK
		 */$scope.dropItemPlaceholder=function(dragged,dropped,position){if(dragged.hasOwnProperty("favorized")||dragged.hasOwnProperty("newblock")){// its a new block
$http.post("admin/api-cms-navitempageblockitem/create",{prev_id:dropped.prev_id,sort_index:0,block_id:dragged.id,placeholder_var:dropped.var,nav_item_page_id:dropped.nav_item_page_id}).then(function(response){$scope.NavItemTypePageController.refreshNested(dropped.prev_id,dropped.var)})}else if(dragged.hasOwnProperty("copystack")){// its a block from copy stack
$http.post("admin/api-cms-navitemblock/copy-block-from-stack",{copyBlockId:dragged.id,sort_index:0,prev_id:dropped.prev_id,placeholder_var:dropped.var,nav_item_page_id:dropped.nav_item_page_id}).then(function(response){$scope.NavItemTypePageController.refreshNested($scope.placeholder.prev_id,$scope.placeholder.var)})}else{// moving an existing block
$http.put("admin/api-cms-navitempageblockitem/update?id="+dragged.id,{sort_index:0,prev_id:dropped.prev_id,placeholder_var:dropped.var}).then(function(response){$scope.refreshForce()})}};/**
		 * Drops a block above/below an EXISTING BLOCK
		 */$scope.dropItem=function(dragged,dropped,position,element){var sortIndex=$scope.$index;if(position=="bottom"){sortIndex=sortIndex+1}if(dragged.hasOwnProperty("favorized")||dragged.hasOwnProperty("newblock")){// its a new block
$http.post("admin/api-cms-navitempageblockitem/create",{prev_id:$scope.placeholder.prev_id,sort_index:sortIndex,block_id:dragged.id,placeholder_var:$scope.placeholder["var"],nav_item_page_id:$scope.placeholder.nav_item_page_id}).then(function(response){$scope.NavItemTypePageController.refreshNested($scope.placeholder.prev_id,$scope.placeholder.var)})}else if(dragged.hasOwnProperty("copystack")){// its a block from copy stack
$http.post("admin/api-cms-navitemblock/copy-block-from-stack",{copyBlockId:dragged.id,sort_index:sortIndex,prev_id:$scope.placeholder.prev_id,placeholder_var:$scope.placeholder["var"],nav_item_page_id:$scope.placeholder.nav_item_page_id}).then(function(response){$scope.NavItemTypePageController.refreshNested($scope.placeholder.prev_id,$scope.placeholder.var)})}else{// moving an existing block
$http.put("admin/api-cms-navitempageblockitem/update?id="+dragged.id,{prev_id:$scope.placeholder.prev_id,placeholder_var:$scope.placeholder["var"],sort_index:sortIndex}).then(function(response){/*
