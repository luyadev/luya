...
// 1.0.0
    ...
    'redirect_model_atr_catch_path_hint' => 'Der Pfad, von dem weitergeleitet werden soll. Sollen auch alle Unterpfade weitergeleitet werden, können Sie die Wildcard * verwenden, z.B. /blog*, um alle Unterpfade von /blog weiterzuleiten.',
    'redirect_model_atr_catch_path_error' => 'Der Pfad muss mit einem Slash / beginnen.',
    'redirect_model_atr_redirect_path' => 'Ziel',
    'redirect_model_atr_redirect_path_hint' => 'Sie können entweder einen absoluten Pfad verwenden, der mit https:// oder http:// beginnt, einen relativen Pfad zum Startverzeichnis der Website, der mit / beginnt, oder einen relativen Pfad zum Pfad, von dem weitergeleitet wird (z.B. wartung, um von /shop/start nach /shop/wartung weiterzuleiten).',
