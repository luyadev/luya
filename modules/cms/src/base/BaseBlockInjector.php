...
use cmsadmin\base\InternalBaseBlock;
 ...
 * 
 * @property \cmsadmin\base\BlockInterface $context The context block object where the injector is placed.
 * @since 1.0.0-rc1
...
abstract class BaseBlockInjector extends Object
{
     ...
     * 
     * @param \cmsadmin\base\BlockInterface $context The block context which will be injected on setup.
     */
     ...
     * 
     * @return \cmsadmin\base\BlockInterface
     */
