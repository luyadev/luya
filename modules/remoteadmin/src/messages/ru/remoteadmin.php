...
return [
    ...
    'status_index_caching_info' => 'Удаленные данные будут закешированны в течении <strong>2 минут</strong>. Вы можете использовать кнопку очистки кеша, чтобы очистить кеш всей страницы.',
