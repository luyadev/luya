...
<script type="text/ng-template" id="reverseFolders">
    ...
    <div class="filemanager__folder-button" ng-click="changeCurrentFolderId(folder.id)" tooltip tooltip-title="folder.name" tooltip-body="folderCountMessage(folder)">
