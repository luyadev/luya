        ...
        <div class="col s12 offset-s0 m6 offset-m3">
            ...
            <div class="card hidden" id="success">
                <div class="login-success">
                    <i class="material-icons login-success-icon green-text">check_circle</i>
                </div>
            </div>
            ...
            <form class="card" method="post" id="loginForm">
                ...
                <div class="card-content clearfix">
                    ...
                    <div class="row">
                        <div class="input input-text input-vertical col s12">
                            <label class="input-label" for="email"><?= Module::t('login_mail'); ?></label>
                            <div class="input-field-wrapper">
                                <input class="input-field" id="email" name="login[email]" type="email" tabindex="1" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="input input-text input-vertical col s12">
                            <label class="input-label" for="password"><?= Module::t('login_password'); ?></label>
                            <div class="input-field-wrapper">
                                <input class="input-field" id="password" name="login[password]" type="password" tabindex="2" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-action">
                    <button class="btn right color green white-text" type="submit"  tabindex="3">
                        ...
                        <div class="preloader-wrapper login-spinner right small active hidden spinner"><div class="spinner-layer"><div class="circle-clipper left"><div class="circle"></div></div></div></div>
                    </button>
            ...
            <form class="card hidden" method="post" id="secureForm">
                ...
                <div class="card-content clearfix">
                    ...
                    <div class="row">
                        <div class="input input-text input-vertical col s12">
                            <label class="input-label" for="secure_token"><?= Module::t('login_securetoken'); ?></label>
                            <div class="input-field-wrapper">
                                <input class="input-field" name="secure_token" id="secure_token" type="text" tabeindex="1" />
