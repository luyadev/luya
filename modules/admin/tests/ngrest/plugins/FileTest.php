...
class FileTest extends \tests\web\BasePlugin
{
    public function testPlugin()
    {
        ...
        $this->assertEquals('<zaa-file-upload fieldid="" fieldname="" model="" label="" i18n=""></zaa-file-upload>', $this->renderCreateHtml($text));
        $this->assertEquals('<zaa-file-upload fieldid="" fieldname="" model="" label="" i18n=""></zaa-file-upload>', $this->renderUpdateHtml($text));
