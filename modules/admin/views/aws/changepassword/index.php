<div ng-controller="ActiveWindowChangePassword">
    ...
    <div class="row">
        <div class="col s12">
            <p><?php echo \admin\Module::t('aws_changepassword_info'); ?></p>
        </div>
    </div>

    <div class="row">
        <div class="input input--text input--vertical col s6">
            <label for="newpass" class="input__label"><?php echo \admin\Module::t('aws_changepassword_new_pass'); ?></label>
        ...
        <div class="input input--text input--vertical col s6">
            <label for="newpasswd" class="input__label"><?php echo \admin\Module::t('aws_changepassword_new_pass_retry'); ?></label>
            <div class="input__field-wrapper">
    ...
    <div class="row">
        <div class="col s12">
            <button class="btn" ng-click="submit()" type="button"><?php echo \admin\Module::t('button_save'); ?></button>
        </div>
    </div>
