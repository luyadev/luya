        ...
        <div class="row">
            <div class="input input--radios col s12">
                ...
                <div class="input__field-wrapper">
                    <input type="radio" ng-checked="data.nav_item_type == 1"><label ng-click="data.nav_item_type = 1"><?php echo \cmsadmin\Module::t('view_index_type_page'); ?></label><br />
                    <input type="radio" ng-checked="data.nav_item_type == 2"><label ng-click="data.nav_item_type = 2; data.is_draft = 0"><?php echo \cmsadmin\Module::t('view_index_type_module'); ?></label><br />
                    <input type="radio" ng-checked="data.nav_item_type == 3"><label ng-click="data.nav_item_type = 3; data.is_draft = 0"><?php echo \cmsadmin\Module::t('view_index_type_redirect'); ?></label><br />
                </div>
            </div>
        </div>
...
<hr style="margin:50px 0px; background-color:#F0F0F0; color:#F0F0F0; height:1px; border:0px;" />
        ...
        <div class="row" ng-show="data.nav_item_type == 1 && !data.isInline">
            <div class="input input--text col s12">
                <label class="input__label"><?php echo \cmsadmin\Module::t('view_index_as_draft'); ?></label>
                <div class="input__field-wrapper">
                    <?php echo \cmsadmin\Module::t('view_index_as_draft_help'); ?><br />
                    <input type="radio" ng-checked="data.is_draft == 0"><label ng-click="data.is_draft = 0"><?php echo \cmsadmin\Module::t('view_index_no'); ?></label><br />
                    <input type="radio" ng-checked="data.is_draft == 1"><label ng-click="data.is_draft = 1"><?php echo \cmsadmin\Module::t('view_index_yes'); ?></label><br />
                </div>
            </div>
        </div>
...
<hr style="margin:50px 0px; background-color:#F0F0F0; color:#F0F0F0; height:1px; border:0px;" />
        ...
        <div ng-show="success">
            <div class="alert alert--success">
                ...
                <p><?php echo \cmsadmin\Module::t('view_index_page_success'); ?></p>
            </div>
        </div>
        <!-- /SUCCESS -->
...
<script type="text/ng-template" id="createformpage.html">
        <div class="row" ng-show="!data.isInline">
            <div class="input input--text col s12">
                <label class="input__label"><?php echo \cmsadmin\Module::t('view_index_page_use_draft'); ?></label>
                <div class="input__field-wrapper">
                    <input type="radio" ng-checked="data.use_draft == 0"><label ng-click="data.use_draft = 0; data.from_draft_id = 0"><?php echo \cmsadmin\Module::t('view_index_no'); ?></label><br />
                    <input type="radio" ng-checked="data.use_draft == 1"><label ng-click="data.use_draft = 1; data.layout_id = 0"><?php echo \cmsadmin\Module::t('view_index_yes'); ?></label><br />
                </div>
            </div>
        </div>
    ...
    <div class="row"ng-show="data.use_draft==1">
        <div class="input input--select col s12">
            <label class="input__label"><?php echo \cmsadmin\Module::t('view_index_page_select_draft'); ?></label>
            <div class="input__field-wrapper">
    ...
    <div class="row">
        <div class="col s12">
            <br />
            <button type="button" class="btn" ng-click="save()"><?php echo \cmsadmin\Module::t('view_index_page_btn_save'); ?></button>
        </div>
    </div>
</script>
<!-- /CREATE PAGE FORM -->
...
<script type="text/ng-template" id="createformredirect.html">
    <div class="row">
        <div class="input input--radios col s12">
            ...
            <div class="input__field-wrapper">
                <input type="radio" ng-model="data.redirect_type" value="1"><label ng-click="data.redirect_type = 1"><?php echo \cmsadmin\Module::t('view_index_redirect_internal'); ?></label> <br />
                <input type="radio" ng-model="data.redirect_type" value="2"><label ng-click="data.redirect_type = 2"><?php echo \cmsadmin\Module::t('view_index_redirect_external'); ?></label>
            </div>
        </div>
    </div>
