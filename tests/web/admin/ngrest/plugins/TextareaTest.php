...
class TextareaTest extends \tests\web\BasePlugin
{
    public function testPlugin()
    {
        ...
        $this->assertEquals('<zaa-textarea fieldid="" fieldname="" model="" label="" grid="" placeholder=""></zaa-textarea>', $this->renderCreateHtml($text));
        $this->assertEquals('<zaa-textarea fieldid="" fieldname="" model="" label="" grid="" placeholder=""></zaa-textarea>', $this->renderUpdateHtml($text));
