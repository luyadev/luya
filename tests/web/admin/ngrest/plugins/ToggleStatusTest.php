...
class ToggleStatusTest extends \tests\web\BasePlugin
{
    public function testPlugin()
    {
        ...
        $this->assertEquals('<zaa-checkbox fieldid="" fieldname="" model="" label="" grid="" options=\'{"true-value":1,"false-value":0}\'></zaa-checkbox>', $this->renderCreateHtml($text));
        $this->assertEquals('<zaa-checkbox fieldid="" fieldname="" model="" label="" grid="" options=\'{"true-value":1,"false-value":0}\'></zaa-checkbox>', $this->renderUpdateHtml($text));
