...
class NumberTest extends \tests\web\BasePlugin
{
    public function testPlugin()
    {
        ...
        $this->assertEquals('<zaa-number fieldid="" fieldname="" model="" label="" grid="" placeholder=""></zaa-number>', $this->renderCreateHtml($text));
        $this->assertEquals('<zaa-number fieldid="" fieldname="" model="" label="" grid="" placeholder=""></zaa-number>', $this->renderUpdateHtml($text));
